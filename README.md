...
Input shape: (30, 139)
Masking: mask_value = 0.0 (ignores padding)
Conv1D: 64 filters, kernel size 5, ReLU, padding="same"
Batch Normalization + MaxPooling1D (pool size 2)
LSTM layers: 64 units (return_sequences=True) → 32 units
Dense layer: 64 units (ReLU)
Dropout: 0.2
Output: Softmax (3 classes)
Optimizer: Adam (learning rate 1e-4)
Loss: Categorical Cross-Entropy
Batch size: 8, epochs up to 50, EarlyStopping on validation loss
